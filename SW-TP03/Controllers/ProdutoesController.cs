...
namespace TPSW03.Controllers
{
    public class ProdutoesController : Controller
    {
        private readonly ContextoProduto _context;

        public ProdutoesController(ContextoProduto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Produto != null ? 
                          ...
                          Problem("Entity set 'ContextoProduto.Produto'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContextoProduto.Produto'  is null.");
            }
            var produto = await _context.Produto.FindAsync(id);
            if (produto != null)
            {
